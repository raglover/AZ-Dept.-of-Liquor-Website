...
<!--<div id="main1"><div id="main2">-->
    ...
    <div class="middle_content">
	  <div id="mccont">
          ...
          <h2>Report Underage Drinking</h2>
            ...
            <tbody>
              <tr>
                <td valign="top" width="79%">
                  <p>The Department of Liquor Licenses and Control appreciates the time and effort you are taking to report your concerns about liquor being sold, served or supplied to a person under the age of 21.  You may also use this form to report any other concerns you have regarding establishments which hold liquor licenses in Arizona.  Please fill in the information below as completely as possible.  Upon request, your name and contact information will remain confidential.</p>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td valign="top"><input id="redirect" type="hidden" name="redirect" value="thank_you.html" />
                        ...
                        <input type="hidden" name="hdwfail" id="hdwfail" value="complaint.asp?hdwmsg=invalid" /></td>
                      <td valign="top">&nbsp;</td>
                    </tr>
                    <tr>
