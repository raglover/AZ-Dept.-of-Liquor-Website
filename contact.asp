...
<title>Arizona Department of Liquor Licenses and Control - Comments, Questions and Suggestions</title>
...
<script language='JavaScript' type='text/javascript' src='assets/js/formValidator.js'></script>
<script language='JavaScript' type='text/javascript'>
function validateform1(formNode){
  var formValidatorInstance = new FormValidator(formNode);
  formValidatorInstance.addRuler('req_name','Please Enter Your Name','required');  formValidatorInstance.addRuler('mailfrom','Please Enter A Valid Email Address','email');  formValidatorInstance.addRuler('req_phone','Please Enter Your Phone Number','required');  return formValidatorInstance.validate(); 
}</script>
</head>
	...
	<div id="slogan">Liquor Licensing and Law Enforcement</div>
                    <div id="searchbar">
              			<form name="fSearch" target="_top" action="http://az.gov/webapp/portal/SiteSearch" method="get" >
	                        ...
	                        <input type="hidden" name="sitehome" value="http://www.azliquor.gov/index.html" />
	                        <input type="hidden" name="sitename" value="Dept. of Liquor Licenses and Control" />
	                        <input type="hidden" name="logo" value="http://www.azliquor.gov/assets/images/dllc_logo.png" />
	                        <input type="hidden" name="template" value="http://www.azliquor.gov/results.html" />
...
<!--<div id="main1"><div id="main2">-->
		    ...
		    <div id="menu">
				<ul>
				    ...
				    <li><a href="contact.html" class="arrow">Contact Us</a>
				        <ul>
				          <li class="nextlevel"><a href="contact.html">Comments Questions Suggestions</a></li>
					...
					<li><a href="reptviol.html">Report Liquor Violations</a></li>   
				</ul>
			</div>
    		<div class="lccont">
		        <h3>Stay In Touch</h3>
		        <ul id="social">
		            <li id="twitter">
		                <a href="http://twitter.com/azdllc">Follow Us On Twitter</a>		            </li>
		            <li id="facebook">
		                <a href="http://www.facebook.com/pages/Phoenix-AZ/State-of-Arizona-Department-of-Liquor-Licenses-and-Control/126337643034">Join Us On Facebook</a>		            </li>
		            <!--<li id="rss">
    ...
    <ul id="state">
        <li id="governor">
            ...
            <a href="http://www.azgovernor.gov" rel="external">Governor's Website</a>        </li>
         <li id="yes">
            <img src="assets/images/misc/yes_logo.png" alt="Arizona State Human Resources" width="70" height="28" />
            <a href="http://www.hr.az.gov/State_Employee/index.asp" rel="external">Employee Services</a>        </li>
    </ul>
    </div></div>
    ...
    <div class="middle_content">
	  <div id="mccont">
          <div class="breadcrumb"><a href="http://www.azliquor.gov">Home</a> &gt; Comments, Questions and Suggestions</div>
            ...
            <tbody>
              <tr>
                <td valign="top" width="79%">
                  <p>The Department of Liquor Licenses and Control welcomes the opportunity to serve you. To continuously improve the services we provide, please email questions, comments and suggestions on the form provided   . When you click the &quot;submit&quot; button below, your email will be sent to us immediately.</p>
              <form onsubmit="return validateform1(this)" action="sendmail.asp" method="post" name="form1">
                <table cellspacing="0" cellpadding="5" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td width="21%"><div align="right"><span class="style2">* </span>Your Name </div></td>
                      <td width="26%"><input id="req_name" name="req_name" /></td>
                      <td colspan="2">Correspondence in regard to:</td>
                    </tr>
                    <tr>
                      <td><div align="right"><span class="style2">* </span>Email Address </div></td>
                      <td><input id="mailfrom" name="mailfrom" /></td>
                      <td width="27%"><input id="sub_director" type="checkbox" name="sub_director" value="Director" />
                        The Director</td>
                      <td width="26%"><input id="sub_audit" type="checkbox" name="sub_audit" value="Audits" />
                        Audits</td>
                    </tr>
                    <tr>
                      <td><div align="right">Business Name </div></td>
                      <td><input id="business_name" name="business_name" /></td>
                      <td><input id="sub_board" type="checkbox" name="sub_board" value="The Liquor Board" />
                        The Liquor Board</td>
                      <td><input id="sub_investigations" type="checkbox" name="sub_investigations" value="Investigations" />
                        Investigations</td>
                    </tr>
                    <tr>
                      <td><div align="right"><span class="style2">* </span>Phone Number </div></td>
                      <td><input id="req_phone" name="req_phone" /></td>
                      <td><input id="sub_compliance" type="checkbox" name="sub_compliance" value="Compliance" />
                        Compliance</td>
                      <td><input id="sub_licensing" type="checkbox" name="sub_licensing" value="Licensing" />
                        Licensing</td>
                    </tr>
                    <tr>
                      <td valign="top" colspan="2"><div align="right">Comments:</div></td>
                      <td valign="top" colspan="2" rowspan="2"><textarea id="comments" rows="5" cols="30" name="comments"></textarea></td>
                    </tr>
                    <tr>
                      <td valign="top"><input id="redirect" type="hidden" name="redirect" value="thank_you.html" />
                        <input id="subject" type="hidden" name="subject" value="** AZLiquor Form Submission **" />
                        <input id="mailto" type="hidden" name="mailto" value="questions@azliquor.gov" />
                        <input id="testmode" type="hidden" name="testmode" value="no" />
                        <input id="html" type="hidden" name="html" value="yes" />
                        <input id="template" type="hidden" name="template" value="liquor_email.html" />
                        <input type="hidden" name="hdwfail" id="hdwfail" value="contact.asp?hdwmsg=invalid" /></td>
                      <td valign="top">&nbsp;</td>
                    </tr>
                    <tr>
                      <td colspan="2" valign="top"><div align="center">800 W. Washington, 5th Floor<br />
Phoenix, AZ 85007<br />
<br />
Phone: (602) 542-5141<br />
Fax (602) 542-5707</div></td>
                      <td valign="top" colspan="2"><img src="/HDWASPFormCaptcha/ASPFormCaptcha.asp?width=180&height=60&letter_count=6&min_size=14&distort=1&rcolor=0&noise=2&ncolor=CC6666&bcolor=ffffff&tcolor=000000" width="180" height="60" id="captchaimg" alt="security code" border="0" /><br />
