                ...
                <table cellspacing="0" cellpadding="5" width="100%" border="0">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td width="27%"><input id="sub_director" type="checkbox" name="sub_director" value="Underage Drinking" />
                        Underage Drinking</td>
                      <td width="26%"><input id="sub_audit" type="checkbox" name="sub_audit" value="Problem Bar" />
                        Problem Bar</td>
                    </tr>
                    <tr>
                      <td><div align="right"><span class="style2">* </span>Phone Number </div></td>
                      <td><input id="req_phone" name="req_phone" /></td>
                      <td><input id="sub_compliance" type="checkbox" name="sub_compliance" value="Problem Restaurant" />
                        Problem Restaurant</td>
                      <td><input id="sub_licensing" type="checkbox" name="sub_licensing" value="Problem Liquor Store" />
                        Problem Liquor Store</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td valign="top"><input id="redirect" type="hidden" name="redirect" value="thank_you.html" />
                        ...
                        <input id="mailto" type="hidden" name="mailto" value="liquor@azliquor.gov" />
                        ...
                        <input type="hidden" name="hdwfail" id="hdwfail" value="reptviol.asp?hdwmsg=invalid" /></td>
                      <td valign="top">&nbsp;</td>
                    </tr>
                    <tr>
